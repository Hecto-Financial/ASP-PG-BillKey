...
REQ_PARAMS.data.set "billKey"   , "" & request.Form("billKey")      '삭제할 빌키(평문 전송, 암호화 대상 아님)
REQ_PARAMS.data.set "etcInfo"   , "" & request.Form("etcInfo")      '해지사유코드(선택)
...
RES_PARAMS.data.set "billKey", ""       '삭제된 빌키


'AES256 암호화 필요한 요청파라미터
'빌키 삭제는 AES256 암호화 대상 파라미터가 없습니다. 빌키는 평문으로 전송합니다.
Dim ENCRYPT_PARAMS : ENCRYPT_PARAMS = array()
...
'   API URL 설정
'============================================================================================================================================
Dim requestUrl : requestUrl = SERVER_URL & "/spay/APICardActionDelkey.do"
