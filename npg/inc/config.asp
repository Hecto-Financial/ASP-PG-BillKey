...
'=======================================================================
const AES256_KEY = "pgSettle30y739r82jtd709yOfZ2yK5K"
...
'=======================================================================
const SERVER_URL = "https://tbgw.settlebank.co.kr" '테스트서버 url
'const SERVER_URL = "https://gw.settlebank.co.kr" '운영서버 url
...
'	로그 파일명 및 경로 수정
'=========================================================================================================
' Windows 예시: "C:/logs/hecto", Linux/Mac 예시: "/var/log/hecto"
const LOG_DIR = "C:/logs/hecto"			'로그 디렉터리(디렉터리가 존재하지 않으면, 로그 파일 생성하지 않습니다.)
const LOG_FILE = "trans.log"			'일반 거래 로그 파일명
const NOTI_LOG_FILE = "noti_trans.log"	'노티 처리 로그 파일명
%>
