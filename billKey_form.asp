...
/** Submit버튼 동작 */
function doAction(){
	$('#STPG_billForm').attr("action", "pay_showResult.asp");
...
<form id="STPG_billForm" name="STPG_billForm" >
    ...
    <tr class="required">
    	<td>mchtId[상점아이디]</td><td><input type="text" name="mchtId" value="<%= PG_MID %>" maxlength="10"/></td>
    </tr>
    ...
    <tr>
        <td>notiUrl[결과처리URL]</td><td><input type="text" name="notiUrl" value="http://localhost/receiveNoti.asp" maxlength="250"/></td>
    </tr>
